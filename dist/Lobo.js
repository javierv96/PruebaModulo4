...
var Lobo = /*#__PURE__*/function (_Animal) {
  _inherits(Lobo, _Animal);
  var _super = _createSuper(Lobo);
  ...
  return Lobo;
}(_Animal2["default"]); // Exporta la clase Lobo para que esté disponible para su uso en otros archivos
var _default = Lobo;
